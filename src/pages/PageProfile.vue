    ...
    <div class="container profile">
      <div class="section profile-heading">
        <div class="columns is-mobile is-multiline">
          ...
          <!-- TODO: Set Active Tab to 'threads' and class to 'isActive' when activeTab === 'threads' -->
          <div
          ...
          <!-- TODO: Set Active Tab to 'posts' and class to 'isActive' when activeTab === 'posts'-->
          <div
